          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                {/* <Link className="nav-link active" aria-current="page" to="TextTransform">Home</Link> */}
                <a className="nav-link active" aria-current="page" href="TextTransform">Home</a>
              </li>
              <li className="nav-item">
                {/* <Link className="nav-link" to="/about">{this.props.about}</Link> */}
                <a className="nav-link" href="/about">{this.props.about}</a>
              </li>
            </ul>
